...
<head>
   ...
   <script type="text/javascript">
    ...
    Username : "saranraj4104@gmail.com",
    Password : "0E0B6039CE4B86E218542D4C8F5B4C971CD7",
    To : 'saranraj4104@gmail.com,kaisanmuhamad@gmail.com,ragupathi17042003@gmail.com',
    From : "saranraj4104@gmail.com",
    Subject : "Comments",
    Body : "Some One Comments On Your Post..."
}).then(
...
<section class="comments-container">
   ...
   <form action="" method="post" class="add-comment">
      ...
      <input type="submit" value="add comment" onclick="sendEmail()" class="inline-btn" name="add_comment">
   ...
   <p class="comment-title">post comments1</p>
   <div class="user-comments-container">
      ...
      <div class="show-comments" style="<?php if($fetch_comments['user_id'] == $user_id){echo 'order:-1;'; } ?>">
        ...
        <div id="myText"> <div class="comment-box"  style="<?php if($fetch_comments['user_id'] == $user_id){echo 'color:var(--white); background:var(--black);'; } ?>"><?= $fetch_comments['comment']; ?></div></div>
